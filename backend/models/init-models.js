...
function initModels(sequelize) {
  ...
  Ingredient.belongsToMany(Recipe, {
    as: "id_recipe_Recipe_Ingredient_recipes",
    through: Ingredient_recipe,
    foreignKey: "id_ingredient",
    otherKey: "id_recipe",
  });
  Ingredient.belongsToMany(User, {
    as: "id_user_User_User_ingredients",
    through: User_ingredient,
    foreignKey: "id_ingredient",
    otherKey: "id_user",
  });
  Recipe.belongsToMany(Ingredient, {
    as: "id_ingredient_Ingredients",
    through: Ingredient_recipe,
  ...
  Recipe.belongsToMany(User, {
    as: "id_user_User_Ratings",
    through: Rating,
    foreignKey: "id_recipe",
    otherKey: "id_user",
  });
  User.belongsToMany(Ingredient, {
    as: "id_ingredient_Ingredient_User_ingredients",
    through: User_ingredient,
    foreignKey: "id_user",
    otherKey: "id_ingredient",
  });
  User.belongsToMany(Recipe, {
    as: "id_recipe_Recipes",
    through: Favourite,
    foreignKey: "id_user",
    otherKey: "id_recipe",
  });
  User.belongsToMany(Recipe, {
    as: "id_recipe_Recipe_Ratings",
    through: Rating,
    foreignKey: "id_user",
    otherKey: "id_recipe",
  });
  ...
  Ingredient.hasMany(Ingredient_recipe, {
    as: "Ingredient_recipes",
    foreignKey: "id_ingredient",
  });
  User_ingredient.belongsTo(Ingredient, {
    as: "id_ingredient_Ingredient",
    foreignKey: "id_ingredient",
  });
  Ingredient.hasMany(User_ingredient, {
    as: "User_ingredients",
    foreignKey: "id_ingredient",
  });
  ...
  User_ingredient.belongsTo(User, {
    as: "id_user_User",
    foreignKey: "id_user",
  });
  User.hasMany(User_ingredient, {
    as: "User_ingredients",
    foreignKey: "id_user",
  });
  Ingredient_diet.belongsTo(Ingredient, {
    as: "id_ingredient_Ingredient",
    foreignKey: "id_ingredient",
  });
  Ingredient.hasMany(Ingredient_diet, {
    as: "Ingredient_diets",
    foreignKey: "id_ingredient",
  });
  Ingredient_diet.belongsTo(Diet, {
    as: "id_diet_Diet",
    foreignKey: "id_diet",
  });
  Diet.hasMany(Ingredient_diet, {
    as: "Ingredient_diets",
    foreignKey: "id_diet",
  });
  ...
  Ingredient_category.belongsTo(Ingredient, {
    as: "id_ingredient_Ingredient",
    foreignKey: "id_ingredient",
  });
  Ingredient_category.belongsTo(Category, {
